...
iface = gr.Interface(
    ...
    flagging_mode="never",
    concurrency_limit=1,
    title="Pneumonia X-Ray Classification with Vision Transformer (ViT) using data augmentation",
    description="Upload an X-ray image to classify it as normal, viral or bacterial pneumonia and visualize the attention heatmap generated by the Vision Transformer (ViT) model.",
)
# Launch the app
if __name__ == "__main__":
    iface.launch(debug=True, footer_links=[])
